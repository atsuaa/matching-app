...
<div class="mb-4 w-full rounded-lg border border-gray-200 bg-gray-50 dark:border-gray-600 dark:bg-gray-700">
    <div class="flex items-center justify-between border-b px-3 py-2 dark:border-gray-600">
        ...
        <div class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700"
    ...
    <div class="rounded-b-lg bg-white px-4 py-2 dark:bg-gray-800">
        <textarea
            ...
            id="{{ $id }}" name="{{ $name }}" rows="8" required="{{ $required }}">{{ $value }}</textarea>
    </div>
</div>
